...
# def update():
        ...
        B_cur.execute("UPDATE employees SET last_name=%s, first_name=%s, gender=%s, mobile_number=%s WHERE employee_number=%s", (lastname,firstname,gender,phonenumber,empnum))
        # pymysql.connection.commit()
        #  email password  first_name gender birthdate mobile_number
        # # try:
